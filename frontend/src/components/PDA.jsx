const COMMANDS = [
  ...
  {
    game: 'exec <unit> <cmd>',
    kubectl: 'kubectl exec <pod> -- <cmd>',
    desc: 'Run a command inside a running unit container.',
    tip: 'Use to inspect the inside of a running pod. Introduced in Level 4.',
  },
  {
    game: 'label unit <unit> <key>=<val>',
    kubectl: 'kubectl label pod <pod> <key>=<val>',
    desc: 'Apply a label to a unit. Labels are used by selectors.',
    tip: 'Labels are how Kubernetes finds and groups resources. Introduced in Level 4.',
  },
  {
    game: 'events <unit>',
    kubectl: 'kubectl get events --field-selector involvedObject.name=<pod>',
    desc: 'Show Kubernetes events for a specific unit.',
    tip: 'Events tell you what Kubernetes was doing when a pod failed. Introduced in Level 2.',
  },
  {
    game: 'rollout status <deployment>',
    kubectl: 'kubectl rollout status deployment/<name>',
    desc: 'Check whether a deployment rollout has completed.',
    tip: 'Always verify after a rollout or rollback. Introduced in Level 3.',
  },
]
